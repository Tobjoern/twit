...
var MAX_FILE_SIZE_BYTES = 512 * 1024 * 1024;
...
var FileUploader = function (params, twit) {
  ...
  self._maxFileSizeBytes = typeof params.maxFileSizeBytes === 'number' ? params.maxFileSizeBytes : MAX_FILE_SIZE_BYTES
}
...
FileUploader.prototype._initMedia = function (cb) {
  ...
  if (mediaFileSizeBytes < self._maxFileSizeBytes) {
    self._twit.post('media/upload', {
      'command': 'INIT',
